...
#ifdef POLAR
    static void moveSteps(float a, float b,uint8_t pathOptimize);
    static void moveRawDeltaSteps(long da, long db,uint8_t pathOptimize);
    static void home(float homeY);
    static void segmentLine();
#endif
